...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            echo "id : " . $row["id"] ."<br>". " nama : " . $row["nama"] 
            ."<br>". "jenis kelamin : " . $row["jenis_kelamin"] ."<br>". "tanggal lahir : " 
            . $row["tanggal_lahir"] ."<br>"."alamat : " . $row["alamat"] ."<br>"."gaji : " 
            . $row["gaji"] ."<br>"."id divisi : " . $row["divisi_id"] ."<br>";
        }
    } else {
        echo " 0 results";
    }
